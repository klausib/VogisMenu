...
class HoehenmodellDialog(QtWidgets.QDialog, Ui_frmHoehenmodell):
...
##            self.leZ.setEnabled(False)
        ...
        if not self.blattschnitt.isValid():     #wenn er nicht geladen werden kann
            QtWidgets.QMessageBox.about(None, "Fehler", "Blattschnitt konnte nicht geladen werden")
    ...
    def hoehenklick(self):
        ...
        #die Blattschnittabfrage ist gedrückt
            ...
            self.PtRueckgabe.disconnect()
            self.PtRueckgabe.canvasClicked.connect(self.returnBlattschnitt)
            #den anderen Knopf wieder lösen!
    ...
    def returnBlattschnitt(self,punkt):
        ...
        self.blattschnitt.selectByRect(wahlRect,False)
